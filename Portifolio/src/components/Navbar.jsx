...
const Navbar = () => {
  // active state to know the links active
  const [active, setActive] = useState('');
  // Toggle state is used to toggle in between actions
    ...
    <nav className={
      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Phani &nbsp;
