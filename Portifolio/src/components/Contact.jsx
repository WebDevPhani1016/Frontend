...
// 1IyvM57XEuprpdRIt
const Contact = () => {
  const templateID = "template_5aars9g";
  const serviceID = "service_5krbrvb";
  const publicKey = "1IyvM57XEuprpdRIt";
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(serviceID, templateID,
      {
        from_name:form.name,
        to_name: 'Phani Putrevu',
        from_email: form.email,
        to_email:'putrevulakshmi.p@gmail.com',
